...
![image](https://marinegeo.github.io/seagrassnet-web/assets/about/SeagrassNet Overview09_2p_img_2.jpg){: height="309.65px" width="404.25px" style="float:right; padding-left:10px" } 

###### *SeagrassNet monitoring on the reef flat in Manada, North Sulawesi, Indonesia*{: style="float:right; padding-left:10px" }
